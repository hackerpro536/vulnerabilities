        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="<?=THEME_URL?>img/hero/banner.jpg">
        ...
        <div class="container">
            <div class="row">
                ...
                <?php foreach($products as $p): ?>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="<?=BASE_URL?><?=$p['images']?>">
                            <h5><a href="<?=BASE_URL?>product.php?id=<?=$p['id']?>"><?=$p['title']?></a></h5>
                        </div>
                    </div>
                <?php endforeach;?>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="<?=THEME_URL?>img/banner/banner-1.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="<?=THEME_URL?>img/banner/banner-2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="<?=THEME_URL?>img/blog/blog-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="<?=THEME_URL?>img/blog/blog-2.jpg" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="<?=THEME_URL?>img/blog/blog-3.jpg" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> May 4,2019</li>

...
<html lang="en">
    <head>
        ...
        <title>Welcome FPT Jetking - Demo Admin Dashboard</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <p>Chào mừng các bạn đến với Workshop: <strong>REAL-WORLD HACKING - WORKSHOP FPT JETKING</strong></p>
                                <p>* ĐÂY LÀ WEBSITE ADMIN PHỤC VỤ CHO MỤC ĐÍCH HỌC TẬP , NGHIÊN CỨU HACKING</p>
                            </div>
                        </div>
                    </div>
                </main>

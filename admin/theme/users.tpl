...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?=ADMIN_URL?>">FPT Jetking</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?=ADMIN_URL?>index.php?logout=1">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Admin Edit Infomation</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Edit Admnin: <?=users('full_name')?>
                            </div>
                            <div class="card-body">
                                <form method="post">
                                    <input type="hidden" name="id" value="<?=users('admin_id')?>">
                                    <div class="form-group mb-3">
                                        <label>Full Name</label>
                                        <input type="text" class="form-control" value="<?=users('full_name')?>" name="full_name">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Email</label>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="<?=users('username')?>" readonly disabled>
                                    </div>
                                    <div class="form-group mb-3">
